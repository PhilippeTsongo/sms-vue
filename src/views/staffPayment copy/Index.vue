      ...
      <div class="flex">
         ...
         <div class="content px-5 py-3 bg-[#F5F7FB] mt-0 border-l border-gray-200">
            ...
            <div class="content rounded-md bg-[#F5F7FB] mt-12">
                ...
                <div class="mb-2 flex">
                    <h1 class="flex-1 text-gray-300 uppercase text-xs"><i class="fa fa-users"></i>Paiement des employés</h1>
                    
                    <div class="">
                        <button v-if="showModal == false" class="border border-green text-green-500 bg-white py-1 px-2 rounded hover:text-white hover:bg-green-500 hover:text-white" @click="toggleModal"><i class="fa fa-plus-circle"></i> Enregistrer les paiements des employés</button>
                    </div>
                </div>
                            ...
                            <div class="register-form rounded-md bg-white px-5 border-gray-900 shadow-xl md:absolute md:ml-auto md:mr-auto md:w-3/4 lg:ml-14">
                                ...
                                <div class="flex py-5 w-full">
                                    <div class="title flex-1">
                                        <h2 class="uppercase text-xl text-green-500"><i class="fa fa-list-ol"></i> Liste des employés</h2>
                                    </div>
                                    <div class="">
                                ...
                                <form @submit.prevent="handleGetDependecy">
                                    <div class="mt-5 pb-5">
                                        <h2 class="uppercase text-green-500 text-xs">Informations de paiments des employés</h2>
                                        <h5 class="mt-3 text-red-500">Les champs obligatoires *</h5>
                                        <div class="mt-5 md:grid grid-flow-col flex-stretch gap-5">
                                            <div class="block md:inline">
                                                <label for="" class="block text-xs uppercase">Nom de l'employé <span class="text-red-500">*</span></label>
                                                <input v-model="search" type="search" class="block border rounded-md p-1 border-gray-300 w-full" required>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form @submit.prevent="handleSubmit">
                                    <div class="flex flex-col m-3 h-100">
                                        <div class="overflow-x-auto sm:-mx-12 lg:-mx-12">
                                            <div class="inline-block max-w-full py-2 sm:px-6 lg:px-8">
                                                    ...
                                                    <table class="rounded border border-gray-200 min-w-full text-left text-sm font-light">                                                        
                                                        <thead class="bg-[#F5F7FB] ">
                                                            <tr class="">
                                                                ...
                                                                <th scope="col" class=" px-3 py-3">Somme payée</th>
                                                                <th scope="col" class=" px-3 py-3">Reste</th>
                                                                <th scope="col" class=" px-3 py-3">Excès</th>
                                                        ...
                                                        <tbody class="h-100 border-r border-b border-gray-200">
                                                            <tr class="">
                                                                ...
                                                                <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200">Jane Doe</td>
                                                                <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200">
                                                                    <div class="block md:inline">
                                                                        <input type="text" v-model="amount" class="block border rounded-md p-1 border-gray-300 w-full" required >
                                                                    </div>
                                                                </td>
                                                                <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200 text-center">
                                                                    <div class="block md:inline">
                                                                        <input type="text" v-model="reminder" class="block border rounded-md p-1 border-gray-300 w-full" required >
                                                                    </div>
                                                                </td>
                                                                <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200 text-center">
                                                                    <div class="block md:inline">
                                                                        <input type="text" v-model="exceding" class="block border rounded-md p-1 border-gray-300 w-full" required >
                                                                    </div>
                                                                </td>
                                                                <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200 text-green-500">
                                                                    <div class="text-center">
                                                                        <button class="text-[#111827] border border-[#111827] w-full rounded-md px-3 py-1 hover:border-none hover:bg-green-500 hover:text-white"> <i class="fa fa-paper-plane-top"></i> Enregistrer</button>
                                                                    </div>    
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr class="">
                                                                <td class="whitespace-nowrap  px-3 py-2 font-medium border-r border-b border-gray-200">1</td>
                                                                <td class="whitespace-nowrap  px-4 w-24 py-2 border-r border-b border-gray-200">34562M23</td>
                                                                <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200">Philippe Tsongo</td>
                                                                <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200">
                                                                    <div class="block md:inline">
                                                                        <input type="text" v-model="amount" class="block border rounded-md p-1 border-gray-300 w-full" required >
                                                                    </div>
                ...
                <div class="flex">
                    ...
                    <div class="flex-1 rounded-md bg-white pt-6 pl-6 pr-6 pb-2 ml-5 mt-2 w-100 ">
                        <div class="bg-[#111827]-100 flex">
                            <div class="title flex-1">
                                <h2 class="uppercase text-xl text-green-500"><i class="fa fa-list-ol"></i> Liste de Paiement</h2>
                            </div>
                                        ...
                                        <table class="rounded border border-gray-200 min-w-full text-left text-sm font-light">
                                            <thead class="bg-[#F5F7FB] ">
                                                <tr class="">
                                                    <th scope="col" class=" px-3 py-3">#</th>
                                                    <th scope="col" class=" px-3 py-3">Nom & Post-Nom</th>
                                                    <th scope="col" class=" px-3 py-3">Somme déjè payée</th>
                                                    <th scope="col" class=" px-3 py-3">Reste</th>
                                                    <th scope="col" class=" px-3 py-3">Excès</th>
                                                    <th scope="col" class=" px-3 py-3">Action</th>
                                            ...
                                            <tbody class="h-100 border-r border-b border-gray-200">
                                                <tr class="">
                                                    ...
                                                    <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200">850</td>
                                                    <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200 text-green-500"> 0 </td>
                                                    <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200 text-green-500"> 0 </td>
                                                ...
                                                <tr class="bg-[#F5F7FB]">
                                                    ...
                                                    <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200">300</td>
                                                    <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200 text-green-500">0</td>
                                                    <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200 text-green-500">0</td>
                                                    <td class="whitespace-nowrap  px-3 py-2 border-r border-b border-gray-200"></td>
                                                </tr>

<template>
    <div class="m-0">
       ...
       <div class="container-fluid ml-0 mr-0 flex">
       
          <Sidebar/>
 
          <div class="content p-5 rounded-md ml-1 mr-1 bg-[#F5F7FB] mt-16">
 
            <div class="mb-2 flex">
                <h1 class="flex-1 mr-24"><i class="fa fa-users text-[#111827]"></i> Etudiants</h1>

                <div class="">
                    <a href="" class="bg-[#111827] p-2 rounded text-white"> <router-link :to="{ name: 'create_student'}"> <i class="fa fa-plus-circle"></i> Nouvel Etudiant  </router-link></a>
                </div>
            </div>
            <!-- <div class="rounded-md bg-white p-7 flex">
                <div class="border-r w-40 mr-10">
                   <a href="" class="text-left text-green-500ray-500"><i class="fa fa-users"></i>  Etudiants</a>
                </div>
            </div> -->

            <div class="rounded-md bg-white pt-6 pl-6 pr-6 pb-2 mt-5">
                <div class="bg-[#111827]-100 flex">
                    ...
                    <div class="" style="margin-top: -5px;">
                        <input  type="search" class="p-1 rounded-md border border-gray-200 serach"> 
                ...
                <div class="flex flex-col m-3 h-96">
                    <div class="overflow-x-auto sm:-mx-12 lg:-mx-12">
                        <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                            <div class="">
                                <table class="table-rounded border border-gray-200 min-w-full text-left text-sm font-light">
                                    ...
                                    <tbody class="h-40 border-r border-gray-200">
                                        <tr class="">
                    ...
                    <div class="flex text-center p-2 mt-5">
                        <div class="lg:px-32 sm:px-10 font-bold">Total: 32</div>
                        <div class="lg:px-32 sm:px-10 font-bold">Actif: 30</div>
                        <div class="lg:px-32 sm:px-10 font-bold">Passif: 2</div>
                    </div>
                </div>
            </div>
          </div>

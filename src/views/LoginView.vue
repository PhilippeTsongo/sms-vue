        ...
        <div >
            <form @submit.prevent="handleSubmit" method="post" action="" class="pt-14 pb-20">
                ...
                <div class="mt-10 px-8 py-5 border rounded ml-auto mr-auto w-96">
                    ...
                    <div class="mt-7 ml-0">
                        <input type="checkbox">
                        <label class="text-gray-400  ml-3">Se souvenir de moi</label>
                    </div>

                    <div class="mt-10">
                        <button type="sumit" :disabled="loading" class="w-full relative ">
                            <div v-if="loading" class="spinner"></div>
                            <span v-else class="bg-green-500 text-white p-2 rounded w-80 uppercase text-lg submit">Connexion</span>
                        </button>
                    </div>
